...
Drinfeld module variant of Deligne's congruence \cite{gek}. We believe that computation of the 
Hasse invariant lift using this recursive formula provides a better path to a potentially more 
efficient polynomial factorization than previous methods.
...
evaluation algorithm. This gives Algorithm \ref{alg:hasse-inv} with the following complexity.
\begin{theorem}
