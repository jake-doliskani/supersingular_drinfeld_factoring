...
In this subsection we set $\beta = 1/2$. Steps \ref{step:hasse-2}, \ref{step:hasse-3}, 
\ref{step:hasse-4} and \ref{step:hasse-5} can each be performed in 
\[ n^{3/2+o(1)} (\log q)^{1+o(1)} + n^{1+o(1)} (\log q)^{2+o(1)}\]
bit operations. We next briefly sketch how.
